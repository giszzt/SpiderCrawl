...
// console.log(_0x34e7[20], u(208));
var p_s = process.argv[2];
// var p_s = "1621685964000";
// var p_s=Date['parse'](new Date)["toString"]();
console.log(window[u(208)](p_s));
